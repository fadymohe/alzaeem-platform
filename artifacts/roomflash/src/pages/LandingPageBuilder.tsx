...
export const LANDING_PAGE_TEMPLATES: LandingTemplateOption[] = [
  {
    ...
    niche: 'شراء مباشر سريع بضغطة واحدة',
    description: 'صفحة هبوط فائقة الفعالية مع باقات خصم 1 و 2 و 3 قطع، عداد تنازلي، واستمارة طلب COD فورية في الواجهة.',
    accentColor: '#0d9488',
  },
  {
    id: 'minimal-luxury',
    name: 'قالب بوتيك الفخامة الملكي (Minimal Luxury)',
    badge: 'فاخر وملكي 💎',
    niche: 'عطور، ساعات، ومجوهرات راقية',
    description: 'تصميم ليلى ملكي بلمسات ذهبية عاجية وشارات الأصالة، يبرز المنتج كتحفة استثنائية مع استمارة طلب مترفة.',
    accentColor: '#d97706',
  },
  {
    id: 'urgency-scarcity',
    name: 'قالب العرض الحصري والعد التنازلي (Urgency Deal)',
    badge: 'عرض محدود وطوارئ 🔥',
    niche: 'تخفيضات كبرى وتصفيات موسمية',
    description: 'شريط عد تنازلي حي في الأعلى، شريط تقدم الكمية المتبقية في المخزن، وحوافز طلب فوري لرفع معدل الشراء.',
    accentColor: '#e11d48',
  },
  {
    id: 'tech-showcase',
    name: 'قالب معرض الابتكار والتقنية (Tech Showcase)',
    badge: 'إلكترونيات وأجهزة ⚙️',
    niche: 'أجهزة ذكية، أدوات، ومعدات تقنية',
    description: 'مصفوفة تفصيلية للمواصفات التقنية، جدول مقارنة بين الأصلي والمقلد، ومؤشرات الجودة والاعتماد.',
    accentColor: '#0284c7',
  },
  {
    id: 'beauty-glow',
    name: 'قالب الجمال والعناية (Beauty & Glow)',
    badge: 'جمال وموضة 🌸',
    niche: 'منتجات العناية بالبشرة، التجميل، والصحة',
    description: 'ألوان باستيل وزهرية ناعمة، بطاقات توضيحية للنتائج، ومكونات آمنة وضمان الفحص والخصوصية التامة.',
    accentColor: '#db2777',
  },
  {
    id: 'compact-sticky',
    name: 'قالب الشراء المدمج الذكي (Smart Mobile Compact)',
    badge: 'خفيف وسريع للموبايل 📱',
    niche: 'تصفح سريع وتجربة هاتف فائقة',
    description: 'تصميم مدمج وبسيط يركز على الهاتف، شريط شراء سفلي عائم دائم، وأسئلة شائعة تفاعلية سريعة.',
    accentColor: '#059669',
  },
];
