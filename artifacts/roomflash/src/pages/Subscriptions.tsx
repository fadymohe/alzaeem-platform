...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    commission: 'عمولة 8 سنت ($0.08) على كل طلب/شحنة',
    badge: '2$ شهرياً فقط ⚡',
    description: 'الخيار الاقتصادي الأمثل للتجار وأصحاب المتاجر مع عمولة 8 سنت فقط على كل طلب.',
    orderLimitText: '5 متاجر احترافية + 50 صفحة هبوط',
    storesLimit: '5 متاجر احترافية متكاملة',
    landingPagesLimit: '50 صفحة هبوط تسويقية',
    features: [
      'اشتراك شهري رمزي بـ 2 دولار فقط (2,600 د.ع)',
      'عمولة 8 سنت ($0.08) فقط على كل طلب وشحنة',
      '5 متاجر احترافية متكاملة مع دومين فرعي مجاني',
      '50 صفحة هبوط تسويقية سريعة ومربوطة',
      'عدد غير محدود من المنتجات والطلبات',
      'ربط أوتوماتيكي مع أسطول الزعيم للشحن السريع',
      'إدارة المنتجات والمخزون وتحصيل المبالغ (COD)',
      'متجرك يظل مفتوحاً حتى لو لم تجدد الاشتراك',
    ],
  },
  {
    id: 'pro',
    ...
    priceUSD: 7,
    priceMonthlyIQD: 9100,
    commission: 'عمولة 4 سنت ($0.04) على كل طلب/شحنة',
    popular: true,
    badge: 'الأقوى للشركات والتجار الكبار 👑',
    description: 'طلبات لا نهائية مع 25 متجراً احترافياً وأقل عمولة 4 سنت فقط وصفحات هبوط لا نهائية.',
    orderLimitText: 'طلبات غير محدودة + 25 متجر احترافي',
    storesLimit: '25 متجر احترافي مستقل',
    landingPagesLimit: 'عدد لا نهائي من صفحات الهبوط',
    features: [
      'اشتراك شهري مخفض بـ 7 دولار فقط (9,100 د.ع)',
      'أقل نسبة عمولة: 4 سنت ($0.04) فقط على كل طلب',
      '25 متجر احترافي مستقل لإدارة عدة براندات',
      'كافة الثيمات والقوالب متاحة ومفتوحة بالكامل',
      'عدد لا نهائي من صفحات الهبوط التسويقية السريعة',
      'عدد غير محدود من المنتجات والطلبات والزيارات',
      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between border-b border-slate-200 dark:border-slate-800 pb-5">
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
            اختر الخطة المناسبة لتجارتك: تجربة مجانية 3 أيام، أو خطة أساسية بـ 2$ (عمولة 8 سنت)، أو خطة احترافية بـ 7$ (عمولة 4 سنت).
          </p>
        </div>
